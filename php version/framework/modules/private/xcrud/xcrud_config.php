<?php /** Configuration file; f0ska xCRUD v.1.6.16; 04/2014 */

$app_settings = require( str_replace('/framework/modules/private/xcrud', '', getcwd()) . '/settings.php' );
define('DB_NAME', $app_settings['database']['name']);
define('DB_HOST', $app_settings['database']['host']);
define('DB_USER', $app_settings['database']['username']);
define('DB_PASSWORD', $app_settings['database']['password']);
...
class Xcrud_config
{
    ...
    public static $date_format = 'yy/mm/dd'; // jqueryui date format
    public static $time_format = 'HH:mm:ss'; // jqueryui time format
    public static $php_date_format = 'Y/m/d'; // php date format
